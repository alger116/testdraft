...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<rake-compiler>.freeze, ["= 1.1.7".freeze])
  s.add_development_dependency(%q<rake-compiler-dock>.freeze, ["= 1.2.2".freeze])
  s.add_development_dependency(%q<rdoc>.freeze, ["~> 6.3".freeze])
  s.add_development_dependency(%q<rexical>.freeze, ["~> 1.0.7".freeze])
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.30.1".freeze])
  s.add_development_dependency(%q<rubocop-minitest>.freeze, ["~> 0.17".freeze])
  s.add_development_dependency(%q<rubocop-performance>.freeze, ["~> 1.12".freeze])
  s.add_development_dependency(%q<rubocop-rake>.freeze, ["~> 0.6".freeze])
  s.add_development_dependency(%q<rubocop-shopify>.freeze, ["= 2.5.0".freeze])
  s.add_development_dependency(%q<ruby_memcheck>.freeze, ["~> 1.0".freeze])
